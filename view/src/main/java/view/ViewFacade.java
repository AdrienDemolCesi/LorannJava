...
public class ViewFacade implements IViewFacade, Runnable, KeyListener {
    ...
    public IMobile          monster1;
    
    public IMobile          monster2;
   ...
   // private Tile tile = new Tile("BlackTile.jpg");
     ...
     */
    public ViewFacade(final ILevel level, final IMobile lorann, IModelFacade Model) throws IOException {
        this.setLevel(level);
        this.setLorann(lorann);
        this.getLorann().getSprite().loadImage();
        
        this.monster1 = Model.getMonster1();
        monster1.getSprite().loadImage();
        
        this.monster2 = Model.getMonster2();
